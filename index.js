...
console.log("soru 1a " , fenomenler[0].profile);


//(2) Dizideki üçüncü fenomenin (2. dizin) takipçi (followers) sayısı

  console.log("soru 1b" , fenomenler[2].followers);
...
console.log("soru 2" , fenomenler[6].profile)
/* 
...
function indekseGoreFenomen(fenomenler,indeks) { // burda kullanılan fenomenleri biz kendimiz öyle isimlendirdik. en yukardaki const fenomenlerle alakası yok.
  return `${indeks}. indekste bulunan fenomen: ${fenomenler[indeks].profile}`
  
}

console.log("soru 3",`${3}. indekste bulunan fenomen: ${fenomenler[3].profile}` )
...
console.log("soru 4",profilListesi(fenomenler))
...
console.log("soru 5" , fenomenSil(fenomenler,2))
...
result.push(yeniFenomen);
    
  return result;
}
console.log("soru 6", fenomenEkle(fenomenler, 6, "Workintech", 10000000, 2022, "Instagram"))
...
console.log("soru 7", enFenomenler(fenomenler))
...
console.log("soru 8 ",fenomenGonderimSayisi(fenomenler,"Will Smith"))
...
function platformaGoreCokGonderiYapanFenomen(fenomenler,platform){
 ...
 let result ;
  for(let i=0; i < fenomenler.length; i++){
    ...
    if(fenomenler[i].platform == platform && fenomenler[i].posts > maxPost ){
...
console.log("soru 9" , platformaGoreCokGonderiYapanFenomen(fenomenler, 'TikTok'))
